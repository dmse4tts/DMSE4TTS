...
def get_dataset_filelist(a):
    with open(a.input_training_file, 'r', encoding='utf-8') as fi:
        training_files = fi.readlines()
    training_files = [line.strip() for line in training_files]
    
    with open(a.input_validation_file, 'r', encoding='utf-8') as fi:
        validation_files = fi.readlines()
    validation_files = [line.strip() for line in validation_files]
...
class MelDataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        if not self.fine_tuning:
            ...
            mel = np.load(filename.replace("audio", "melspec").replace(".wav", ".npy"))
